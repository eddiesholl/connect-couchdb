...
module.exports = function(session) {
    ...
    function ConnectCouchDB(opts, fn)  {
        ...
        this.ignoreConflicts = opts.ignoreConflicts || false;
    ...
    ConnectCouchDB.prototype.set = function (sid, sess, fn) {
        ...
        var wrappedFn = function(err, doc) {
           var isConflict = err && err.statusCode == 409;
           if (!err || (isConflict && ignoreConflicts)) {
               return fn(null, doc);
           } else {
               return fn(err, doc);
           }
